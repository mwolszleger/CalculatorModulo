function displayGame() {
    ...
    document.getElementsByClassName("panel-body")[0].innerHTML = "<div >Number n:</div><div id=\"numberToFactorize\">Loading number...</div><div>Divisor of n:</div><div class=\"n-field-prefix\">&nbsp;</div><input type=\"text\" onClick=\"erase();\" id=\"divisor\" value=\"1\"></div><div>Your name:</div><div><div class=\"n-field-prefix\">&nbsp;</div><input type=\"text\" onClick=\"erase();\" id=\"name\" value=\"Anonymous\"></div><button onclick=\"checkGame();\" type=\"button\">Check</button><div id=\"messageBox\">&nbsp;  </div><div id=\"resultsTable\">Loading table...</div>";
    $.ajax({
